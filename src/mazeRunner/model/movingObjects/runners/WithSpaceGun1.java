...
public class WithSpaceGun1 extends RunnerDecorator {

	public WithSpaceGun1(IRunner runner, int ammo, int oneBulletDamage) {
		super(runner);
		Weapon newWeapon = new WeaponFactory().getWeapon("spaceGun1", ammo, oneBulletDamage);
