...
public class MovingController {
	...
	public MovingController(BuildingController buildingController) {
		...
		playingPane = playingView.getPlayingPane(this.runner.getCurrentWeapon().getBulletsCount(),
				this.runner.getCurrentWeapon().getImageLink(),
				this.runner.getCurrentWeapon().getClass().getSimpleName());
	}
	...
	public void actionHandeling() {
		...
		StartGame.scene.setOnKeyPressed((KeyEvent event) -> {
			if (event.getCode() == KeyCode.W) {
				...
				System.out.println(runner.getPrevWeapon());
				...
				System.out.println(runner.getSupportedWeapons());
				System.out.println(runner.getNextWeapon());
